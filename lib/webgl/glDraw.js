...
function glSetTextures(diffuse, normal, relief, emissive)
{
	...
	else gl.uniform1i(glShaderUniforms.color_map, -1);
	...
	else gl.uniform1i(glShaderUniforms.normal_map, -1);
	...
	else gl.uniform1i(glShaderUniforms.relief_map, -1);
	...
	else gl.uniform1i(glShaderUniforms.emissive_map, -1);
}
...
function glGenerateEmissive(image, reliefTexture)
{
	...
	//console.log(glEmissiveFramebuffer, glRenderbuffer, image.width, image.height);
