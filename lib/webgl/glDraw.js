...
/*
	...
	Every frame : 
		...
		glDrawCell(cellw, cellh, column, row, x, y, imageWidth, imageHeight, intensity, diffuse, normal, relief, emissive, light1, light2, light3, parentWidth, parentHeight, parentX, parentY, parentRelief);
*/
var vSource =
[
...
function glDrawCell(cellw, cellh, column, row, x, y, imageWidth, imageHeight, intensity, diffuse, normal, relief, emissive, light1, light2, light3, parentWidth, parentHeight, parentX, parentY, parentRelief)
{
	if (!gl) return null;
