...
/*
	...
	Every frame : 
		...
		//	diffuse, normal, relief : WebGl objects that represent the textures
		//	light1, light2, light3 : the lights given to draw
		glDraw(width, height, x, y, diffuse, normal, relief, light1, light2, light3);
*/
...
function glDraw(width, height, x, y, diffuse, normal, relief, emissive, light1, light2, light3)
{
	gl.uniformMatrix4fv(glShaderUniforms.proj, false, new Float32Array(perspective_matrix.flatten()));
	gl.uniform2fv(glShaderUniforms.screen, new Float32Array([glCanvas.width, glCanvas.height]));
	gl.uniform2fv(glShaderUniforms.dimensions, new Float32Array([width, height]));
	gl.uniform2fv(glShaderUniforms.position, new Float32Array([x, y]));
	//gl.uniform3fv(glShaderUniforms.ambient_color, new Float32Array([1.0, 1.0, 1.0]));
	...
	{
		gl.uniform2fv(glShaderUniforms.pointlight1, new Float32Array(light1.position));
		gl.uniform3fv(glShaderUniforms.light1_falloff, new Float32Array(light1.falloff));
		gl.uniform3fv(glShaderUniforms.light1_color, new Float32Array(light1.color));
		lights++;
	}
	if (light2 != undefined || light2 != null)
	{
		gl.uniform2fv(glShaderUniforms.pointlight2, new Float32Array(light2.position));
		gl.uniform3fv(glShaderUniforms.light2_falloff, new Float32Array(light2.falloff));
		gl.uniform3fv(glShaderUniforms.light2_color, new Float32Array(light2.color));
		lights++;
	}
	if (light3 != undefined || light3 != null)
	{
		gl.uniform2fv(glShaderUniforms.pointlight3, new Float32Array(light3.position));
		gl.uniform3fv(glShaderUniforms.light3_falloff, new Float32Array(light3.falloff));
		gl.uniform3fv(glShaderUniforms.light3_color, new Float32Array(light3.color));
		lights++;
	}
