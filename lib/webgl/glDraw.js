...
/*
	...
	Every frame : 
		...
		glDrawCell(width, height, x, y, cellw, cellh, column, row, parentWidth, parentHeight, parentX, parentY, intensity, diffuse, normal, relief, emissive, parentRelief, light1, light2, light3);
*/
var vSource =
[
	...
	"	parent_coord = parent_box0 + (vertex.zw * (parent_box1 - parent_box0));", 
...
function glDrawCell(width, height, x, y, cellw, cellh, column, row, parentWidth, parentHeight, parentX, parentY, intensity, diffuse, normal, relief, emissive, parentRelief, light1, light2, light3)
{
	if (!gl) return null;
	if (diffuse == null && normal == null && relief == null) return null;
	if (diffuse == undefined && normal == undefined && relief == undefined) return null;
