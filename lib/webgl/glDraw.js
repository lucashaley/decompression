...
[
	...
	//"	vec2 pos0 = position - vec2(dimensions.x / 2., dimensions.y / 2.);", 
	"	light1_pos = pointlight1 / screen;", 
	"	light1_uv = clamp((pointlight1 - position) / dimensions, 0., 1.);", 
	"	light2_pos = pointlight2 / screen;", 
	"	light2_uv = clamp((pointlight2 - position) / dimensions, 0., 1.);", 
	"	light3_pos = pointlight3 / screen;", 
	"	light3_uv = clamp((pointlight3 - position) / dimensions, 0., 1.);", 
...
[
	...
	"	vec3 light2_relief = vec3(light2_pos, -light2_depth + 0.1);", 
	"	vec3 light3_relief = vec3(light3_pos, -light3_depth + 0.1);", 
	...
	"	//gl_FragColor = vec4(light1_uv, 0., 1.);", 
