...
[
	...
	"	vec3 light1_relief = vec3(light1_pos, 0.1);//-light1_depth + 0.1);", 
	"	vec3 light2_relief = vec3(light2_pos, 0.1);//-light2_depth + 0.1);", 
	"	vec3 light3_relief = vec3(light3_pos, 0.1);//-light3_depth + 0.1);", 
