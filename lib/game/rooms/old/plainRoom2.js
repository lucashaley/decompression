...
.defines(function () {
    Infirmary = BaseRoom.extend({
        ...
        init: function () {
            this.textures.diffuse = AssetCore.textures.infirmary_D;
            this.textures.normal = AssetCore.textures.infirmary_N;
            this.textures.relief = AssetCore.textures.infirmary_R;
            this.textures.emissive = AssetCore.textures.infirmary_E;
            this.parent();
