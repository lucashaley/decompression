...
.defines(function(){
	NewRoom = ig.Class.extend({
        ...
        diffuse: new ig.Image('lib/game/media/rm_vrbay_01_D.png'),
        normal: new ig.Image('lib/game/media/rm_vrbay_01_N.png'),
        relief: new ig.Image('lib/game/media/rm_vrbay_01_R.png'),
        emissive: new ig.Image('lib/game/media/rm_vrbay_01_E.png'),
