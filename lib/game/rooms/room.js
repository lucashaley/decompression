...
.defines(function(){
	...
	NewRoom = ig.Class.extend({
        ...
        init: function() {
            ...
            this.tiles = [];
            this.initiateTiles(this.roomX, this.roomY, this.tileGridWidth, this.tileGridHeight, this.tileHeightOffset);j
    ...
    Hangar = NewRoom.extend({
        ...
        init: function(){
            ...
            //set tiles here
            //example: this.setTile(97, 'lib/game/media/door.png');
            this.setTile(14, 'lib/game/media/door.png');
    ...
    RecRoom = NewRoom.extend({
        ...
        init: function(){
            ...
            //set tiles here
            //example: this.setTile(97, 'lib/game/media/door.png');
            this.setTile(45, 'lib/game/media/door.png');
