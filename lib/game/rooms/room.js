...
=======
        draw: function(lightIntense) {
            if(this.img != null) glDraw(this.img.width, this.img.height, this.x, this.y, this.texture, null, null, null, null, null, null, lightIntense);
	...
	NewRoom = ig.Class.extend({
		...
		draw: function() {
            ...
            glDraw(this.diffuse.width, this.diffuse.height, this.roomX, this.roomY, 
                ...
                this.lights[0], this.lights[1], null, this.lightIntensity);
