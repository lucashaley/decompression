...
.defines(function(){
    PopUpMenu = ig.Class.extend ({
        ...
        set: function(type) {
            this.type = type;
            if(type == 'move') this.img = new ig.Image('lib/game/media/PopUps/moveMenu.png');
            else if(type == 'attack') this.img = new ig.Image('lib/game/media/PopUps/attackMenu.png');
            else if(type == 'loot') this.img = new ig.Image('lib/game/media/PopUps/lootMenu.png');
            else this.img = new ig.Image('lib/game/media/PopUps/noActionMenu.png');
    ...
    Tile = ig.Class.extend ({
        ...
        draw: function(lightIntense) {
            ...
            if(this.selected) this.menu.draw(this.x+65, this.y+40, lightIntense);
        },
