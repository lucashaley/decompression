...
.defines(function(){
	Hallway = ig.Class.extend({
		roomX = 0,
		roomY = 0,

		diffuse: new ig.Image('media/rm_hallway_01_D.png'),
        normal: new ig.Image('media/rm_hallway_01_N.png'),
        relief: new ig.Image('media/rm_hallway_01_R.png'),
        emissive: new ig.Image('media/rm_hallway_01_E.png'),
