...
.defines(function(){
	JunkItem = BaseItem.extend({
		...
		init : function()
		{
			...
			var junkNames = ['A Potted Plant', 'Empty Bottle', 'Broken Keycard', 'Wasted Ammo', 'Scrap Parts', 'Empty Cardboard Box', 'Video Game', 'Powerless Cell Phone', 'Trashed Paperwork', 'Power Cord'];
