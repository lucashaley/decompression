...
.defines(function(){
	EntityPlayer = ig.Entity.extend({
        ...
        onTurnUpdate : function()
        {
    		...
    		if (!this.actions.hasAttacked && GameCore.targetedEnemy != null && this.currentRoom.hasEnemies)// selected attack action
    		{
    		...
    		if (!this.actions.hasScavenged && false && this.currentRoom.hasItems)// selected scavenge action
    		{
