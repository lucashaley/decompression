...
.defines(function(){
	EntityPlayer = ig.Entity.extend({
		...
		transition : function(targetDoor)
		{
			...
			GameCore.movePlayerTo(targetDoor.connectingRoom, targetDoor);
		...
		ability : function()
		{
			switch (this.abilityName)
			{
				...
				if (junkFound != 2 || item1 == null || item2 == null) return;
		...
		takeDamage : function(dmgAmount, isNeurotoxin)
		{
			...
			{
				Chat.push('IMMUNE TO NEUROTOXIN');
				return;
			}
