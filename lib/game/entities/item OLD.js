...
.defines(function(){
	EntityItem = ig.Entity.extend({
		JunkSheet: new ig.AnimationSheet('media/items/JunkSheet.png', 150, 150),
		KeyCardSheet: new ig.AnimationSheet('media/items/KeyCardSheet.png', 150, 150),
		WeaponSheet: new ig.AnimationSheet('media/items/WeaponSheet.png', 150, 150),
		HealingSheet: new ig.AnimationSheet('media/items/HealingSheet.png', 150, 150),
		AugmentSheet: new ig.AnimationSheet('media/items/AugmentSheet.png', 150, 150),
		MiscSheet: new ig.AnimationSheet('media/items/MiscSheet.png', 150, 150),
		TrapSheet: new ig.AnimationSheet('media/items/TrapSheet.png', 150, 150),
