...
.defines(function(){
	EntityItem = ig.Entity.extend({
		...
		flip : false,		
		//Has this item been activated if it's an augment?
		activated : false,
		...
		init : function(itemName) {
			...
			var DiscoveryImplant = new ig.Animation(AugmentSheet, 1, [1] );
			var DefenseImplant = new ig.Animation(AugmentSheet, 1, [2] );
			var CommandImplant = new ig.Animation(AugmentSheet, 1, [3] );
			var ReflexImplant = new ig.Animation(AugmentSheet, 1, [4] );
			var QuantumImplant = new ig.Animation(AugmentSheet, 1, [5] );

			var ExoSuit = new ig.Animation(AugmentSheet, 1, [6] );			
			...
			switch(itemName){
				...
				case (40):
					...
					break;	
				case ('DiscoveryImplant'):
				case (41):
					idNum = 41;
					displayName = "Discovery Implant";					
					itemType = Augment;
					description = "Exploration costs only 1 Action";
					this.currentAnim = this.anims.DiscoveryImplant;
				...
				case (42):
					idNum = 42;
					displayName = "Defense Implant";					
					itemType = Augment;
					description = "+3 Max Health";
					this.currentAnim = this.anims.DefenseImplant;
				...
				case (43):
					idNum = 43;
					displayName = "Command Implant";					
					itemType = Augment;
					description = "Nearby allies get +2 Attack Effectiveness";
					this.currentAnim = this.anims.CommandImplant;
				...
				case (44):
					idNum = 44;
					displayName = "Reflex Implant";					
					itemType = Augment;
					description = "Actions per turn increased to 3";
					this.currentAnim = this.anims.ReflexImplant;
				...
				case (45):
					idNum = 45;
					displayName = "Quantum Implant";					
					itemType = Augment;
					description = "Resurrect in an Infirmary upon death";
					this.currentAnim = this.anims.QuantumImplant;
		...
		onUse : function(usingPlayer, targetEntity) {
			...
			switch(itemName){
				...
				case (64):
					//description : "Destroy any non boss creep";
					this.uses = 0;
					if(targetEntity instanceof EntityEnemy) {
