...
.defines(function(){
	EntityDoor = ig.Entity.extend({
		...
		draw: function()
		{
			...
			var lockTex = AssetCore.textures.doorLock_inactive;
			if (this.locked) lockTex = AssetCore.textures.doorLock_active;
			glDraw(256, 256, this.pos.x + this.currentRoom.corner.x, this.pos.y + this.currentRoom.corner.y, this.currentRoom.intensity, lockTex);
			if (this.currentRoom.isLockedDown)
			{
				glDraw(256, 256, this.pos.x + this.currentRoom.corner.x, this.pos.y + this.currentRoom.corner.y, this.currentRoom.intensity, AssetCore.textures.doorLock_lockdown);
			}
        	glSetFlipped(false);
		}, 
