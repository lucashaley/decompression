...
.defines(function(){
	TycheBoss = BaseEnemy.extend({
		...
		{
			this.parent();
			this.addAnimSheet('FL Idle', AssetCore.requestAnim('Tyche FL Idle'));
			this.addAnimSheet('FR Idle', AssetCore.requestAnim('Tyche FR Idle'));
			this.addAnimSheet('RL Idle', AssetCore.requestAnim('Tyche RL Idle'));
			this.addAnimSheet('RR Idle', AssetCore.requestAnim('Tyche RR Idle'));
		...
		onPlayerAction : function(player)
		{
            ...
            {
            	Chat.push(this.name + ScriptCore.TycheDamageAllPlayers);
