...
.defines(function () {
    ...
    GameScreen = ig.Game.extend({
        ...
        init: function () {
            ...
            this.nextRoom.roomX = canvas.width/2;
            this.nextRoom.roomY = canvas.height/2;
            ...
            this.nextRoom.lights[0] = new Light(689, 378, 8.5, 10.4, 20.0, 0.8, 0.9, 1.0);
            this.nextRoom.lights[1] = new Light(408, 555, 8.6, 12.0, 32.0, 1.0, 0.8, 0.75);
        ...
        update: function () {
            ...
            if(ig.input.pressed('upLeft')) {
                ...
                this.nextRoom.roomX = this.currentRoom.roomX + canvas.width/2;
                this.nextRoom.roomY = this.currentRoom.roomY + canvas.height/2;
                this.nextRoom.lights[0].position[0] += canvas.width/2;
                this.nextRoom.lights[0].position[1] += canvas.height/2;
                this.nextRoom.lights[1].position[0] += canvas.width/2;
                this.nextRoom.lights[1].position[1] += canvas.height/2;
            }
