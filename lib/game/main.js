...
.defines(function () {
    ...
    LogoScreen = ig.Game.extend({
        ...
        init: function() {
            ...
            this.textures.push(this.background.data);
        },
        update: function() {
            //to leave screen
    ...
    LobbyScreen = ig.Game.extend({
        ...
        draw: function () {
            ...
            his.font.draw('Server Name: ' + serverName, cntrX, scrHgt * .4, ig.Font.ALIGN.CENTER);
            this.backButton.draw();
    ...
    GameScreen = ig.Game.extend({
        ...
        init: function () {
            ...
            this.textures.push(glGenerateEmissive(this.emissive.data, this.textures[2]));

            this.lights.push(new Light(689, 378, 0.4, 2.4, 12.0, 0.8, 0.9, 1.0));
        ...
        update: function () {
            ...
            if(ig.input.pressed('rightMouse')) {
                //ig.system.setGame(StatsScreen);
                this.lights[1].position[0] = ig.input.mouse.x;
                this.lights[1].position[1] = glCanvas.height - ig.input.mouse.y;
            }
        },
