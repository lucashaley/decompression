...
.defines(function () {
    ...
    var textField = menuButton.extend({
        ...
        init: function(x, y, w, h, texty, color) {
            this.parent(x, y, w, h, texty, color);
        },
        ...
        draw: function() {
            ...
            this.instructText.draw( this.buttonText + serverName, this.x, this.y, ig.Font.ALIGN.LEFT );            
        }
    });
    ...
    CreateScreen = ig.Game.extend({       
        ...
        init: function () {
            ...
            this.serverNameField.init(ig.system.width/2, ig.system.height * .4, 200, 30, 'server: ', '#008')
        },
