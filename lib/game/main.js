...
.defines(function () {
    ...
    GameScreen = ig.Game.extend({
        ...
        init: function()
        {
            ...
            //GameCore.players[0].addItem(ItemCore.generateRandomItem());
            //GameCore.players[0].addItem(ItemCore.generateRandomItem());
        ...
        update: function()
        {
            ...
            if (ig.input.pressed('leftMouse'))
            {
                ...
                if (this.abilityButton.isMouseOver() && !Chat.minimized)
                {
                    GameCore.selectedUseAbility = true;
                }
                else if (this.scavengeButton.isMouseOver() && !Chat.minimized)
                {
                    GameCore.selectedScavenge = true;
                }
                else if (this.endTurnButton.isMouseOver() && !Chat.minimized)
                {
