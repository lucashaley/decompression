...
.defines(function () {
    ...
    GameScreen = ig.Game.extend({
        ...
        draw: function () {
            ...
            glDraw(this.diffuse.width, this.diffuse.height, cntrX, cntrY, this.textures[0], this.textures[1], this.textures[2], this.textures[3], this.lights[0], this.lights[1], null);
        }
    });
