...
=======
        ...
        itemList.appendItem = function (num,name){
            //Adds item to the array, num is both slot number and idNum
            itemList[num] = name;
            itemList[num].idNum;
        },
>>>>>>> c079c644a4095c4c00f49bdf93920705320ed67b
        ...
        init: function () {
            ...
            this.currentRoom.roomX = canvas.width/2;
            this.currentRoom.roomY = canvas.height/2;
            this.currentRoom.diffuse = new ig.Image('lib/game/media/rm_recreation_01_D.png'),
            this.currentRoom.normal = new ig.Image('lib/game/media/rm_recreation_01_N.png'),
            this.currentRoom.relief = new ig.Image('lib/game/media/rm_recreation_01_R.png'),
            this.currentRoom.emissive = new ig.Image('lib/game/media/rm_recreation_01_E.png'),
            this.currentRoom.lights[0] = new Light(689, 378, 0.5, 2.4, 12.0, 0.8, 0.9, 1.0);
            this.currentRoom.lights[1] = new Light(408, 555, 0.6, 4.0, 24.0, 1.0, 0.8, 0.75);
            this.currentRoom.lights[2] = new Light(800, 450, 0.6, 3.2, 18.0, 1.0, 1.0, 1.0);

            this.nextRoom.roomX = 9000;
            this.nextRoom.roomY = 6900;
            this.nextRoom.diffuse = new ig.Image('lib/game/media/rm_recreation_01_D.png'),
            this.nextRoom.normal = new ig.Image('lib/game/media/rm_recreation_01_N.png'),
            this.nextRoom.relief = new ig.Image('lib/game/media/rm_recreation_01_R.png'),
            this.nextRoom.emissive = new ig.Image('lib/game/media/rm_recreation_01_E.png'),
            this.nextRoom.lights[0] = new Light(1000, 200, 7.3, 9.2, 18.8, 0.8, 0.9, 1.0);
            this.nextRoom.lights[1] = new Light(800, 100, 7.3, 10.8, 30.8, 1.0, 0.8, 0.75);
            this.nextRoom.lights[2] = new Light(800, 450, 0.6, 3.2, 18.0, 1.0, 1.0, 1.0);
...
=======
            ...
            itemList.appendItem(1, 'ScrapParts');
            ...
            // Weapon items
            itemList.appendItem(20, 'LaserPistol');
            itemList.appendItem(21, 'Shotgun');
            ...
            // Misc items
            itemList.appendItem(40, 'Backpack');
            itemList.appendItem(41, 'Teleporter');
            itemList.appendItem(42, 'SensorImplant');
            itemList.appendItem(43, 'RepairKit');
            itemList.appendItem(44, 'SystemReset');
            itemList.appendItem(45, 'Reprogrammer');

            itemList.appendItem(46, 'AirMask');
            itemList.appendItem(47, 'RevivalKey');
            itemList.appendItem(48, 'FriendlyDrone');
            itemList.appendItem(49, 'ResourceDetector');
            itemList.appendItem(50, 'OverrideKey');
            itemList.appendItem(51, 'ExoSuit');
...
>>>>>>> c079c644a4095c4c00f49bdf93920705320ed67b
        ...
        update: function () {
            ...
            if(ig.input.state('rightMouse')) {
                this.currentRoom.lights[0].position[0] = ig.input.mouse.x;
                this.currentRoom.lights[0].position[1] = glCanvas.height - ig.input.mouse.y;
            }
            ...
            if(ig.input.pressed('upLeft')) {
                ...
                this.nextRoom.roomX = 1180;
                this.nextRoom.roomY = 800;
                this.nextRoom.lights[0].position[0] = 1000;
                this.nextRoom.lights[0].position[1] = 200;
                this.nextRoom.lights[0].position[0] = 800;
                this.nextRoom.lights[0].position[1] = 100;
            }
                ...
                this.nextRoom.roomX = 100;
                this.nextRoom.roomY = 800;
                this.nextRoom.lights[0].position[0] = 280;
                this.nextRoom.lights[0].position[1] = 200;
                this.nextRoom.lights[0].position[0] = 480;
                this.nextRoom.lights[0].position[1] = 100;
            }
                ...
                this.nextRoom.roomX = 1180;
                this.nextRoom.roomY = 0;
                this.nextRoom.lights[0].position[0] = 1000;
                this.nextRoom.lights[0].position[1] = 600;
                this.nextRoom.lights[0].position[0] = 800;
                this.nextRoom.lights[0].position[1] = 700;
            }
            ...
            if( this.isMoving) {
                this.currentRoom.roomX += this.moveDirX;
                this.currentRoom.roomY += this.moveDirY;
                this.currentRoom.lights[0].position[0] += this.moveDirX;
                this.currentRoom.lights[0].position[1] -= this.moveDirY;
                this.currentRoom.lights[0].falloff[0] += .1;
                this.currentRoom.lights[0].falloff[1] += .1;
                this.currentRoom.lights[0].falloff[2] += .1;
                this.currentRoom.lights[1].position[0] += this.moveDirX;
                this.currentRoom.lights[1].position[1] -= this.moveDirY;
                this.currentRoom.lights[1].falloff[0] += .1;
                this.currentRoom.lights[1].falloff[1] += .1;
                this.currentRoom.lights[1].falloff[2] += .1;


                this.nextRoom.roomX += this.moveDirX;
                this.nextRoom.roomY += this.moveDirY;
                this.nextRoom.lights[0].position[0] += this.moveDirX;
                this.nextRoom.lights[0].position[1] -= this.moveDirY;
                this.nextRoom.lights[0].falloff[0] -= .1;
                this.nextRoom.lights[0].falloff[1] -= .1;
                this.nextRoom.lights[0].falloff[2] -= .1;
                this.nextRoom.lights[1].position[0] += this.moveDirX;
                this.nextRoom.lights[1].position[1] -= this.moveDirY;
                this.nextRoom.lights[1].falloff[0] -= .1;
                this.nextRoom.lights[1].falloff[1] -= .1;
                this.nextRoom.lights[1].falloff[2] -= .1;

                //if(this.nextRoom.roomY == canvas.height/2) {
                if(this.currentRoom.roomX <= 100 || this.currentRoom.roomX >=1180) {
                    this.isMoving = false;
